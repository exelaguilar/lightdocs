...
final class CatalogEntry
{
	...
	private ?PackageProof $proof;

	public function __construct(string $name, string $version, string $channel, string $archiveUri, string $archiveSha256, ?PackageProof $proof = null)
	{
	...
	public function proof(): ?PackageProof { return $this->proof; }
}
