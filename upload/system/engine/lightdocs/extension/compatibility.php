...
final class Compatibility
{
	 ...
	 */
	public function evaluate(Manifest $manifest, array $platformVersions): array
	{
		$failures = [];
	...
	/** @param array<string,string> $platformVersions */
	public function assertCompatible(Manifest $manifest, array $platformVersions): void
	{
	...
	public function assertUpgrade(string $currentVersion, Manifest $candidate): void
	{
		try {
