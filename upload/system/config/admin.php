...
return [
    ...
    'routes' => [
        ...
        '/admin/forgot' => 'common/login.forgot',
        '/admin/reset' => 'common/login.reset',
        ...
        '/admin/glossary/{term}/edit' => 'tools/glossary.edit',
        ...
        '/admin/extensions/{name}/settings' => 'tools/extension_settings',
        ...
        '/admin/logs' => 'tools/logs',
        '/admin/logs/content' => 'tools/logs.content',
        '/admin/logs/clear' => 'tools/logs.clear',
        '/admin/logs/download' => 'tools/logs.download',
        '/admin/system' => 'tools/system',
        '/admin/system/clear-opcache' => 'tools/system.clearOpcache',
        '/admin/broadcast' => 'tools/broadcast',
        '/admin/broadcast/create' => 'tools/broadcast.create',
        '/admin/broadcast/expire' => 'tools/broadcast.expire',
        '/admin/broadcast/delete' => 'tools/broadcast.delete',
        '/admin/users' => 'common/users',
        '/admin/users/new' => 'common/users.create',
        '/admin/users/{id}/edit' => 'common/users.edit',
        '/admin/roles' => 'common/roles',
        '/admin/roles/add' => 'common/roles.create',
        '/admin/roles/{role}/edit' => 'common/roles.edit',
