...
final class ExportService
{
	...
	public function archive(string $profile, bool $acknowledge_secrets): string
	{
		...
		$archive_path = $folder . '.zip';
		try {
			$this->builder->build($folder, $profile, $acknowledge_secrets);
