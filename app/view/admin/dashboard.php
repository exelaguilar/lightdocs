  ...
  <div class="dashboard-grid">
    <section class="dashboard-panel">
      ...
      <div class="recent-content-list">
        <?php foreach ($recentPages as $page): ?><a href="/admin/editor?file=<?= rawurlencode($page->relativePath) ?>"><span class="page-icon" aria-hidden="true"></span><span><strong><?= $e($page->title) ?></strong><small><?= $e($page->relativePath) ?> · <?= $e(date('M j, Y', $page->modifiedAt)) ?></small></span><?php if ($page->isPrivate()): ?><i>Private</i><?php elseif ($page->isDraft()): ?><i>Draft</i><?php endif; ?></a><?php endforeach; ?>
      </div>
    </section>
    ...
    <aside class="dashboard-column">
      <section class="dashboard-panel index-panel">
        ...
        <dl><div><dt>Documents</dt><dd><?= (int) ($indexStats['documents'] ?? 0) ?></dd></div><div><dt>Headings</dt><dd><?= (int) ($indexStats['headings'] ?? 0) ?></dd></div><div><dt>Keywords</dt><dd><?= (int) ($indexStats['keywords'] ?? 0) ?></dd></div><div><dt>Links</dt><dd><?= (int) ($indexStats['links'] ?? 0) ?></dd></div></dl>
